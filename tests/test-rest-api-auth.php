 ...
 * あわせて、閲覧権限のあるユーザーのリクエストは従来どおり通ること、および唯一の例外である
 * 「本人自身のアプリケーションパスワード」のエンドポイントは閲覧権限が無いユーザーでも
 * 通ることを検証する。
 */
class RestApiAuthTest extends WP_UnitTestCase {
	 ...
	 * 契約外の falsy な値でガードが無効化されないこと、および唯一の例外である「本人自身の
	 * アプリケーションパスワード」のエンドポイントは閲覧権限が無くても通ることを検証する。
	 *
